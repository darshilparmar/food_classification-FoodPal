...
$query = "INSERT INTO foodlog (email, time1, date1, food_name, calories, protien, carbs, fibre, fats) VALUES ('".$email."','".date('H:i:s', $time_now)."','".date("Y-m-d")."','".$myArray[0]."','".$row['Energ_Kcal']."','".$row['Protein']."', '".$row['Carbohydrt']."', '".$row['Fiber_TD']."', '".$row['Lipid_Tot']."')";
...
<body>
	...
	<div class="row">
		<div class="col s12 l12">
			<center><img src="python/images/xyz.jpg" style="height: 400px;width: 90%;border: 1px dashed red 90%;"></center>
	...
	<div class="row">
		<div class="col offset-s4 s8 l3 offset-l4" style="padding-top: 40px;">
	...
	<div class="row">
		<div class="col s12  offset-l4 l3">
